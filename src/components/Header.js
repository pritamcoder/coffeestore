...
const Header = () => {
  return (
    <header className="paddingall bg-[#e2e2e2]  bg-right bg-no-repeat bg-contain h-screen flex justify-around lg:justify-between items-center  flex-col lg:flex-row ">
      ...
      <div className='lg:w-[50%]'>
        <h1 className='text-rose-300'>add image</h1>
